...
:: AI助审专用（DeepSeek 云端优先）
set AI_ASSISTANT_GRAPH_AUDIT_BASE_URL=https://api.deepseek.com/v1
set AI_ASSISTANT_GRAPH_AUDIT_MODEL=deepseek-chat
set AI_ASSISTANT_GRAPH_AUDIT_API_KEY=sk-841bf3a09ecf4d4d8ff7ce3b156a73a0
...
set AI_ASSISTANT_GRAPH_BUILD_MAX_CHUNKS=0
